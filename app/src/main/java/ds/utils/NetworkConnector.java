...
public class NetworkConnector {
    ...
    private final String HOST_URL = "http://192.168.56.1:8080/server/";
    ...
    public static final String DELETE_LISTSBOOK_REQ = "2";
    ...
    public static final String INSERT_ListBookManyToMany_REQ = "8";
    public static final String DELETE_ListBookManyToMany_REQ = "9";//////////////didnt
    public static final String DELETE_ListBookManyToMany_SpecificRow_REQ = "10";//////////////didnt
    public static final String GET_ListBookManyToMany = "11";

    ////chapter

    public static final String INSERT_CHAPTER_REQ = "12";
    public static final String DELETE_CHAPTER_BY_BOOKID_REQ = "13";
    public static final String DELETE_CHAPTER_REQ = "14";
    public static final String GET_CHAPTER_IMAGE_REQ = "15";
    public static final String GET_CHAPTER_JSON_REQ = "16";
    ...
    public static final String INSERT_COMMENT_REQ = "17";
    public static final String DELETE_COMMENT_REQ = "18";
    public static final String DELETE_COMMENT_SpecificRow_REQ = "19";
    public static final String GET_COMMENT = "20";
    //  chapterId, userName,
    ...
    //////////////////////////////////////////////////library
    private static final String GET_Library_JSON_REQ = "21";
    public static final String INSERT_Library_REQ = "22";
    public static final String DELETE_Library_REQ = "23";
    //////////////////////////////////////////////////Like

    public static final String DELETE_Like_REQ = "24";
    public static final String INSERT_Like_REQ = "25";
    private static final String GET_Like_JSON_REQ = "26";
    ...
    private synchronized void addToRequestQueue(String query, final NetworkResListener listener, final String requestNum) {
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.POST, reqUrl, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        notifyPostUpdateListeners(response, ResStatus.SUCCESS, listener, requestNum);
                    }
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        try {
                            ...
                            notifyPostUpdateListeners(err, ResStatus.FAIL, listener, requestNum);
                        }
    ...
    private void uploadBookImage(final Book data, final NetworkResListener listener) {
        ...
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, reqUrl,
                new Response.Listener<NetworkResponse>() {
                    ...
                    public void onResponse(NetworkResponse response) {
                        try {
                            ...
                            notifyPostUpdateListeners(obj, ResStatus.SUCCESS, listener, "i dont  know ");
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        try {
                            ...
                            notifyPostUpdateListeners(obj, ResStatus.FAIL, listener, "i dont  know ");
                        }
             ...
             * you can do it here
             * here i have only one parameter with the image
             * which is tags
             * */
            @Override
            ...
            /*
             * Here i am passing image by renaming it with a unique name
             * */
            @Override
    ...
    public void sendRequestToServer(String requestCode, Book data, NetworkResListener listener) {
        ...
        switch (requestCode) {
            ...
            case INSERT_BOOK_REQ: {
                ...
                addToRequestQueue(query, listener, INSERT_BOOK_REQ);
            ...
            case DELETE_BOOK_REQ: {
                ...
                String query = builder.build().getEncodedQuery();
                addToRequestQueue(query, listener, DELETE_BOOK_REQ);
    ...
    public void sendRequestToServer(String requestCode, ListBookManyToMany data, NetworkResListener listener) {
        ...
        switch (requestCode) {
            case INSERT_ListBookManyToMany_REQ: {
                ...
                String query = builder.build().getEncodedQuery();
                addToRequestQueue(query, listener, INSERT_ListBookManyToMany_REQ);
            ...
            case DELETE_ListBookManyToMany_REQ: {
                ...
                String query = builder.build().getEncodedQuery();
                addToRequestQueue(query, listener, DELETE_ListBookManyToMany_REQ);
            ...
            case DELETE_ListBookManyToMany_SpecificRow_REQ: {
                ...
                String query = builder.build().getEncodedQuery();
                addToRequestQueue(query, listener, DELETE_ListBookManyToMany_SpecificRow_REQ);
    ...
    public void update(NetworkResListener listener, String userName) {
        ...
        String query = builder.build().getEncodedQuery();
        addToRequestQueue(query, listener, GET_ALL_LISTSBOOK_JSON_REQ);

        builder = new Uri.Builder();
        builder.appendQueryParameter(REQ, GET_COMMENT);
        query = builder.build().getEncodedQuery();
        addToRequestQueue(query, listener, GET_COMMENT);

        builder = new Uri.Builder();
        builder.appendQueryParameter(REQ, GET_Book_JSON_REQ);
        query = builder.build().getEncodedQuery();
        addToRequestQueue(query, listener, GET_Book_JSON_REQ);


        builder = new Uri.Builder();
        builder.appendQueryParameter(REQ, GET_CHAPTER_JSON_REQ);
        query = builder.build().getEncodedQuery();
        addToRequestQueue(query, listener, GET_CHAPTER_JSON_REQ);

        builder = new Uri.Builder();
        builder.appendQueryParameter(REQ, GET_ListBookManyToMany);
        query = builder.build().getEncodedQuery();
        addToRequestQueue(query, listener, GET_ListBookManyToMany);


        builder = new Uri.Builder();
        builder.appendQueryParameter(REQ, GET_Like_JSON_REQ);
        builder.appendQueryParameter(USER_NAME, userName);
        query = builder.build().getEncodedQuery();
        addToRequestQueue(query, listener, GET_Like_JSON_REQ);

        builder = new Uri.Builder();
        builder.appendQueryParameter(REQ, GET_Library_JSON_REQ);
        builder.appendQueryParameter(USER_NAME, userName);
        query = builder.build().getEncodedQuery();
        addToRequestQueue(query, listener, GET_Library_JSON_REQ);
    ...
    public void sendRequestToServer(String requestCode, BookList data, NetworkResListener listener) {
        ...
        switch (requestCode) {
            case INSERT_LISTSBOOk_REQ: {
                ...
                addToRequestQueue(query, listener, requestCode);
    ...
    private void notifyPostUpdateListeners(final JSONObject res, final ResStatus status, final NetworkResListener listener, final String requestNum) {
        ...
        Runnable myRunnable = new Runnable() {
            ...
            public void run() {
                try {
                    listener.onPostUpdate(res, status, requestNum);
                } catch (Throwable t) {
                    t.printStackTrace();
                }
            }
...
//                }
    ...
    public void sendRequestToServer(String requestCode, String userName, String bookId, NetworkResListener listener) {
        ...
        switch (requestCode) {
            case INSERT_Library_REQ: {
                ...
                String query = builder.build().getEncodedQuery();
                addToRequestQueue(query, listener, INSERT_Library_REQ);

                break;
            }

            case DELETE_Library_REQ: {
                builder.appendQueryParameter(REQ, requestCode);
                builder.appendQueryParameter(USER_NAME, userName);
                builder.appendQueryParameter(BOOK_ID, bookId);

                String query = builder.build().getEncodedQuery();
                addToRequestQueue(query, listener, DELETE_Library_REQ);

                break;
            }


            case INSERT_Like_REQ: {
                ...
                String query = builder.build().getEncodedQuery();
                addToRequestQueue(query, listener, INSERT_Like_REQ);

                break;
            }

            case DELETE_Like_REQ: {
                builder.appendQueryParameter(REQ, requestCode);
                builder.appendQueryParameter(USER_NAME, userName);
                builder.appendQueryParameter(BOOK_ID, bookId);

                String query = builder.build().getEncodedQuery();
                addToRequestQueue(query, listener, DELETE_Like_REQ);
