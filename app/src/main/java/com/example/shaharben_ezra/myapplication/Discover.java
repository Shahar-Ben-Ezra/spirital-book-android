...
public class Discover extends Fragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Book_frag(MyInfoManager.getInstance().getAllBooks()), "RECOMMENDED");
        adapter.addFragment(new Book_frag(MyInfoManager.getInstance().getAllBooks()), "NEWEST");
